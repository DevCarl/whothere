(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'babel-runtime/helpers/typeof', 'babel-runtime/helpers/objectWithoutProperties', 'babel-runtime/helpers/extends', 'babel-runtime/core-js/get-iterator', './Parser', 'querystring'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('babel-runtime/helpers/typeof'), require('babel-runtime/helpers/objectWithoutProperties'), require('babel-runtime/helpers/extends'), require('babel-runtime/core-js/get-iterator'), require('./Parser'), require('querystring'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global._typeof, global.objectWithoutProperties, global._extends, global.getIterator, global.Parser, global.querystring);
    global.Torrent = mod.exports;
  }
})(this, function (exports, _typeof2, _objectWithoutProperties2, _extends2, _getIterator2, _Parser, _querystring) {
  'use strict';
  ...
  function search() {
    ...
    var page = _searchDefaults$caste.page;
    var category = _searchDefaults$caste.category;
    var orderBy = _searchDefaults$caste.orderBy;
    var sortBy = _searchDefaults$caste.sortBy;
    var rest = (0, _objectWithoutProperties3.default)(_searchDefaults$caste, ['page', 'category', 'orderBy', 'sortBy']);
  ...
  exports.default = {
    ...
    getTvShow: getTvShow, getCategories: getCategories, baseUrl: baseUrl, searchDefaults: searchDefaults, defaultOrder: defaultOrder
  };
});