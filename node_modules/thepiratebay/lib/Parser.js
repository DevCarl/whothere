(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'babel-runtime/core-js/promise', 'babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', 'cheerio', 'isomorphic-fetch', './Torrent', 'url-parse'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('babel-runtime/core-js/promise'), require('babel-runtime/regenerator'), require('babel-runtime/helpers/asyncToGenerator'), require('cheerio'), require('isomorphic-fetch'), require('./Torrent'), require('url-parse'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.promise, global.regenerator, global.asyncToGenerator, global.cheerio, global.isomorphicFetch, global.Torrent, global.urlParse);
    global.Parser = mod.exports;
  }
})(this, function (exports, _promise, _regenerator, _asyncToGenerator2, _cheerio, _isomorphicFetch, _Torrent, _urlParse) {
  'use strict';
  ...
  function parseResults(resultsHTML) {
    ...
    var results = rawResults.map(function getRawResults() {
      ...
      return {
        ...
        subcategory: subcategory, uploader: uploader, verified: verified, uploaderLink: uploaderLink
      };
    });
  ...
  function parseTorrentPage(torrentPage) {
    ...
    return {
      name: name, size: size, seeders: seeders, leechers: leechers, uploadDate: uploadDate, magnetLink: magnetLink, link: link,
      id: id, description: description, uploader: uploader, uploaderLink: uploaderLink
    };
  }
