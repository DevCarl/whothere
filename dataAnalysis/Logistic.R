...
##CASE 1: Wifi_Max_clients
Logitmodel1 <- glm(Binary_Occupancy ~Wifi_Max_clients  + Factor_Time + Course_Level,family=binomial,AnalysisTable)

CVbinary (Logitmodel1, nfolds= 10)
#Cross-validation estimate of accuracy = 0.778 

##CASE 2: Wifi_AVERAGE_clients
Logitmodel2 <- glm(Binary_Occupancy ~Wifi_Average_clients + Factor_Time + Course_Level,family=binomial,data=train)
