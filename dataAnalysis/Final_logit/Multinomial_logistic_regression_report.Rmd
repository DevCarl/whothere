...
The best model in term of accuracy and AIC was Binned_occupancy ~ Wifi_Average_logs + Room with accuracy equals to 0.58 and AIC equal to 364.
...
The best model in term of accuracy and AIC was Binned_occupancy ~ Wifi_Max_logs + Room  with an accuracy of 0.55 and an AIC of 385.
...
Binned_occupancy ~ Wifi_Average_logs + Room  was the best model in term of AIC (377) and accuracy (0.575). However, the ordinal regression did not improve the accuracy of the multinomial logistic regression. Similar pattern were observed for Wifi_Max_logs as dependent variable.
...
The best model in term of AIC (391) and accuracy (0.57) was Binned_Occupancy ~ Wifi_Max_logs+Room. The occuracy of this model was not better than the accuracy of the ordinal model with Wifi_Average_logs as dependent variable. 
