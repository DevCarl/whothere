...
occupancy_plot <- ggplot(data=occupancy_table, aes(x=factor(Time), y=Predicted_occupancy, fill=Predicted_occupancy)) + geom_bar(stat="identity")+ scale_fill_manual(values=c( "orangered","darkcyan","gold", "blue"))+ theme_bw()
