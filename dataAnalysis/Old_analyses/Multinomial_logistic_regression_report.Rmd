...
Binned_occupancy ~ Wifi_Average_logs + Room  was the best model in term of AIC (377) and accuracy (0.575). Howevre, the ordinal regression did not improve the accuracy of the multinomial logistic regression. Similar pattern were expected from running the same analyses, but with Wifi_Max_logs as dependent variable.
